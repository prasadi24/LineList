...
namespace LineList.Cenovus.Com.API.DataTransferObjects.SegmentType
{
    public class SegmentTypeEditDto
    {
        ...
        [Required(ErrorMessage = "This field is required.")]
        [StringLength(60, ErrorMessage = "This field length must be between {2} and {1} characters.", MinimumLength = 2)]
